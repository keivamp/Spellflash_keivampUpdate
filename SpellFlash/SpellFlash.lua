...
local Event = {}
local EventFrame = CreateFrame("Frame",BackdropTemplateMixin and "BackdropTemplate")
...
CreateFrame("GameTooltip", "SpellFlashAddon_Tooltip", nil, "GameTooltipTemplate",BackdropTemplateMixin and "BackdropTemplate")
...
hookLibButtonGlow()
local labHookFrame = CreateFrame("Frame",BackdropTemplateMixin and "BackdropTemplate")
...
function s.RegisterModuleEvent(AddonName, Event, Function)
	if not ModuleEvents[AddonName] then
		...
		ModuleEvents[AddonName].EventFrame = CreateFrame("Frame",BackdropTemplateMixin and "BackdropTemplate")
